...
class host:
    ...
    def add_metric(self, which_metric, value):
    ...
    def add_metrics(self, load, util, ecpu, emem, mem, threads):
        self.add_metric("CPU Load", load)
        self.add_metric("CPU Utilization", util)
        self.add_metric("ESX CPU", ecpu)
        self.add_metric("ESX Memory", emem)
        self.add_metric("Memory", mem)
        self.add_metric("Threads", threads)
